...
(autothemer-deftheme
 ...
 ((default                                   (:foreground darktooth-light0 :background darktooth-dark0))
  ...
  (elfeed-search-title-face                  (:foreground darktooth-light3))
  (elfeed-search-unread-count-face           (:foreground darktooth-muted_cyan :bold nil))
  (elfeed-search-unread-title-face           (:foreground darktooth-light0_hard :bold nil))

  ;; MODE SUPPORT: notmuch
  (notmuch-hello-logo-background (:inherit 'default))
  (notmuch-message-summary-face (:foreground darktooth-light0_soft :background darktooth-dark4 :weight 'bold))
  (notmuch-search-count (:inherit 'default))
  (notmuch-search-date (:foreground darktooth-neutral_cyan))
  (notmuch-search-flagged-face (:foreground darktooth-bright_cyan))
  (notmuch-search-matching-authors (:inherit 'default))
  (notmuch-search-non-matching-authors (:inherit 'default))
  (notmuch-search-subject (:inherit 'default))
  (notmuch-search-unread-face (:weight 'bold))
  (notmuch-tag-added (:underline darktooth-neutral_green))
  (notmuch-tag-deleted (:strike-through darktooth-neutral_red))
  (notmuch-tag-face (:foreground darktooth-neutral_yellow))
  (notmuch-tag-flagged (:foreground darktooth-bright_blue))
  (notmuch-tag-unread (:foreground darktooth-neutral_red))
  (notmuch-tree-match-author-face (:foreground darktooth-neutral_blue))
  (notmuch-tree-match-date-face (:foreground darktooth-neutral_yellow))
  (notmuch-tree-match-tag-face (:foreground darktooth-neutral_cyan))
